    ...
    <div className="overflow-hidden md:p-10 p-5">
      <Slider {...settings}>
        {(collections?.length <= 2
          ...
          return (
            <div className="px-2">
              <div className="flex gap-4 bg-gradient-to-tr  to-[#b0d1cd] from-[#ffffff] p-7 w-full rounded-xl h-full">
                <div className="w-full flex flex-col gap-2">
                  ...
                  <div className="flex gap-4">
                    <Link href={`/collections/${collection?.id}`}>
                      <button className="bg-[#31a898] text-white text-xs md:text-sm px-4 py-2 rounded-lg">
                        SHOP NOW
                      </button>
                    </Link>
                  </div>
